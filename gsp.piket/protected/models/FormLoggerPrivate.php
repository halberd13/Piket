...
class FormLoggerPrivate{
        
    static public function buildLoggerPrivate($param){
        $doc = new DOMDocument('1.0');
        $doc->formatOutput = true;
        $eltLogger = $doc->createElement('logger');
        $attrName = $doc->createAttribute('name');
        $attrName->value = $param['NAME_LOGGER_PRIVATE'];
        ...
        $propertyLogListener_1 = $propertyLogListener->propertyLogListener($doc, $param['NAME_LOGGER_PRIVATE_FILE']);
        ...
        $propertyLogListener_2 = $propertyLogListener->propertyLogListener($doc, $param['NAME_LOGGER_PRIVATE_FILE']);
        ...
        $doc->save("config/".$param['FILE_NAME_LOGGER_PRIVATE']);
    }
