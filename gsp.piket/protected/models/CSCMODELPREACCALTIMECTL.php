...
/**
 * This is the model class for table "CSCMOD_EL_PRE_ACC_ALTIME_CTL".
 *
 * The followings are the available columns in table 'CSCMOD_EL_PRE_ACC_ALTIME_CTL':
 ...
 */
class CSCMODELPREACCALTIMECTL extends CActiveRecord
{
	/**
	...
	{
		return 'CSCMOD_EL_PRE_ACC_ALTIME_CTL';
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'CSM_ATC_CID' => 'empty means any PPID',
			'CSM_ATC_DESC' => 'Csm Atc Desc',
			'CSM_ATC_ALLOW_WDAY' => '0=mon, 1=tue, 2=wed, 3=thu, 4=fri, 5=sat, 6=sun (use mysql WEEKDAY() function). in PHP, 0=sun, 1=mon, ..., 6=sat.',
	 ...
	 * @return CSCMODELPREACCALTIMECTL the static model class
	 */
