...
/**
 * This is the model class for table "CSCMOD_WAU_ACC_ALTIME_CTL".
 *
 * The followings are the available columns in table 'CSCMOD_WAU_ACC_ALTIME_CTL':
 ...
 */
class CSCMODWAUACCALTIMECTL extends CActiveRecord
{
	/**
	...
	{
		return 'CSCMOD_WAU_ACC_ALTIME_CTL';
	}
	 ...
	 * @return CSCMODWAUACCALTIMECTL the static model class
	 */
